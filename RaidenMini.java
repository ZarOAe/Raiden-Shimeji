...
public class RaidenMini extends JWindow {
  ...
  private ImageIcon[] preloadedImages = new ImageIcon[14];
  ...
  public RaidenMini() {
    ...
    for (int i = 1; i <= 13; i++) {
      preloadedImages[i - 1] = new ImageIcon("img/shime" + i + ".png");
    }
  ...
  private void updateUIFrame() {
    ...
    if (frame >= 1 && frame <= 13) {
      label.setIcon(preloadedImages[frame - 1]);
    }
  }
